...
export const metadata: Metadata = {
  title: "Плитка для частного дома: выбор для каждой комнаты | Дом Плитки СПб",
  description: "Как выбрать плитку для частного дома в СПб. Керамогранит для полов и стен в разных комнатах. Советы от официального дилера Cersanit.",
      ...
      <article className="mx-auto max-w-4xl px-4 py-10">
        ...
        <div className="prose prose-sm max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-base leading-relaxed">При выборе керамогранита или керамической плитки обратите внимание на класс износостойкости (PEI), морозостойкость и водопоглощение. Качественная плитка от надежного производителя, такого как Cersanit, прослужит десятилетия без потери внешнего вида. Официальный дилер Cersanit в Санкт-Петербурге предложит вам самые надежные и стильные решения для вашего дома.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-base leading-relaxed">Для фартука над рабочей зоной идеально подходит плитка среднего размера — она практична и красиво смотрится. Светлые тона визуально расширяют пространство кухни, а темные керамогранит скрывает грязь. В нашем магазине в районе Янино и на других объектах Санкт-Петербурга представлены коллекции Cersanit специально для кухонных пространств.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-base leading-relaxed">Крупноформатная плитка 60x120 см визуально делает комнату просторнее и требует меньше швов. Она проще укладывается и легче моется. Светлый керамогранит под мрамор или светлое дерево идеален для небольших помещений. В каталоге официального дилера Cersanit в Санкт-Петербурге вы найдете сотни вариантов для любого интерьера.</p>
          </section>
