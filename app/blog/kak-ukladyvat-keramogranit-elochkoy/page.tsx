...
export const metadata: Metadata = {
  title: "Укладка керамогранита ёлочкой и диагональю: пошаговая инструкция | Дом Плитки СПб",
  description: "Полная инструкция по укладке керамогранита ёлочкой и диагональю. Советы мастеров Cersanit Санкт-Петербурга. Пошаговое руководство для начинающих.",
  alternates: { canonical: `${SITE_URL}/blog/kak-ukladyvat-keramogranit-elochkoy` },
  openGraph: { title: "Укладка керамогранита ёлочкой и диагональю: пошаговая инструкция | Дом Плитки СПб", url: `${SITE_URL}/blog/kak-ukladyvat-keramogranit-elochkoy`, siteName: "Дом Плитки CERSANIT", locale: "ru_RU", type: "article" },
}
    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="mx-auto max-w-4xl px-4 py-10">
        ...
        <div className="mb-8 text-gray-600">
          <p>Опубликовано: 6 апреля 2026 | Официальный дилер Cersanit в Санкт-Петербурге</p>
        </div>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-700">Эти техники требуют большей аккуратности и расчётов, но результат того стоит. Официальный дилер Cersanit в Янино и по всему Санкт-Петербургу рекомендует керамогранит от Cersanit именно для таких укладок — материал отличается идеальной геометрией и прочностью. Давайте разберёмся, как правильно выполнить эту работу.</p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mb-4">Подготовка: материалы и инструменты</h2>
            <p className="text-gray-700 mb-4">Перед началом укладки керамогранита необходимо подготовить всё необходимое. Выбор качественного материала — это половина успеха. Керамогранит Cersanit из нашего магазина в Санкт-Петербурге полностью соответствует международным стандартам и гарантирует ровную укладку.</p>
            <p className="text-gray-700 mb-3">Вам понадобятся:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 mb-4">
              <li>Керамогранит Cersanit нужного размера и количеством с запасом 10%</li>
          ...
          <section>
            ...
            <p className="text-gray-700">В Санкт-Петербурге, особенно в районе Янино, многие владельцы выбирают именно эту технику для ванных комнат и кухонь. Керамогранит Cersanit идеально подходит для такой укладки благодаря точным размерам и устойчивости к влаге. После завершения укладки подождите 24 часа перед затиркой швов.</p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700">В Санкт-Петербурге диагональная укладка плитки часто используется в больших помещениях — холлах жилых комплексов, офисах, торговых центрах. Керамогранит Cersanit, который предлагает наш магазин, имеет размеры от 30х30 см до 120х120 см, что позволяет подобрать оптимальный вариант для любого проекта. Диагональная укладка выглядит особенно эффектно на крупноформатном керамограните.</p>
          </section>
