...
export const metadata: Metadata = {
  title: "Морозостойкая плитка для улицы в СПб | Керамогранит Cersanit",
  description: "Выбираем морозостойкую уличную плитку для Санкт-Петербурга. Керамогранит, характеристики, укладка. Официальный дилер Cersanit.",
  alternates: { canonical: `${SITE_URL}/blog/morozostojkaya-plitka-dlya-ulicy` },
  openGraph: { title: "Морозостойкая плитка для улицы в СПб | Керамогранит Cersanit", url: `${SITE_URL}/blog/morozostojkaya-plitka-dlya-ulicy`, siteName: "Дом Плитки CERSANIT", locale: "ru_RU", type: "article" },
}
      ...
      <article className="mx-auto max-w-4xl px-4 py-10">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
          ...
          <section>
            ...
            <p className="mb-4">Cersanit предлагает широкий ассортимент технического керамогранита специально для уличных работ. Наши коллекции прошли испытания в суровых климатических условиях и подтверждены сертификатами морозостойкости. Плитка от Cersanit сохраняет цвет и фактуру годами, не подвергаясь истиранию и деформации.</p>
            <p>Как официальный дилер Cersanit в Санкт-Петербурге, мы гарантируем оригинальность материала и его полное соответствие европейским стандартам качества. Керамогранит — это долгосрочное решение для вашего сада, входной зоны или мощения.</p>
          </section>
          ...
          <section>
            ...
            <p>Цвет плитки для Санкт-Петербурга лучше выбирать более светлый — такая поверхность не перегревается летом и лучше видна в снег и туман. Рассмотрите варианты серого, бежевого или светло-коричневого керамогранита из коллекций Cersanit, которые идеально подходят для климата СПб и улиц Янино.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">Популярные коллекции Cersanit для уличного применения</h2>
            <p className="mb-4">Компания Cersanit разработала специализированные линейки керамогранита для экстремальных климатических условий. Плитка проходит серьёзные тесты на морозостойкость и выдерживает циклы замораживания-оттаивания, характерные для Санкт-Петербурга и северных регионов России.</p>
            <p className="mb-4">Технический керамогранит Cersanit отличается однородной структурой, что обеспечивает равномерное распределение нагрузки и исключает образование пустот. Противоскользящая поверхность создана специально для уличных условий, где безопасность пешеходов критична.</p>
          ...
          <section>
            ...
            <p>Уход за уличной плиткой простой: регулярная очистка от грязи и листьев, удаление льда без использования острых инструментов, применение специальных средств для очистки два раза в год. Наш магазин в районе Янино и центре СПб предоставляет консультации по уходу за каждой коллекцией Cersanit.</p>
          </section>
